...
def create_ensemble_retriever(vector_store):
    ...
    try:
        ...
        print("✅ Added BM25 retriever to ensemble")
    except Exception as e:
        print(f"⚠️ BM25 retriever not available: {e}")
...
def create_rag_chain(retriever):
    ...
    """
    print("🔗 **Creating RAG Chain with Ensemble Retriever**")
    print("=" * 60)
...
def display_results(result):
    ...
    Display Results
    """
    print("📊 **Ensemble Retriever Evaluation Results**")
    print("=" * 60)
